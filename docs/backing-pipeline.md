# SlopScale Backing-Track Pipeline — Generation, Humanization & DSP

> Written to be shareable with the Slopsmith host team: a review of how SlopScale
...
SlopScale is a practice/learning tool — the backing track is a *means* (a band
