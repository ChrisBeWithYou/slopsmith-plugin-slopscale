...
try {
  ...
  await page.evaluate(() => { document.getElementById("slopscale-stop")?.click(); document.getElementById("slopscale-results-close")?.click(); });   // dedicated Stop (Play toggles pause) + dismiss the results modal
