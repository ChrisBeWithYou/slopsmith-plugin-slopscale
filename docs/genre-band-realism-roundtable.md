...
harmony-theory · sound-design · slopsmith-host-expert. Main thread synthesized.
...
## 6. HOST CHECK summary (slopsmith-host-expert, runtime 0.2.9, 2026-06-13)
...
| Imminent host audio roadmap | **nothing to wait for** | Audio roadmap is native-engine/CDLC plumbing; no sampler/FX item. |
